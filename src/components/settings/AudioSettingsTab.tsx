...
const BGM_STYLES: {
...
}[] = [
  {
    key: 'lofi',
    name: 'Lo-Fi Cafe',
    desc: 'Piano điện ấm áp, đĩa than cổ điển thư thái, bass trầm êm',
    bpm: 64,
    icon: Coffee,
    color: '#FF6B00',
  },
  {
    key: 'ambient',
    name: 'Dreamy Ambient',
    desc: 'Không gian bồng bềnh lơ lửng, hợp âm Lydian & chuông sao rơi',
    bpm: 52,
    icon: Sparkles,
    color: '#8B5CF6',
  },
  {
    key: 'lounge',
    name: 'Night Lounge',
    desc: 'Hợp âm Jazz hoàng hôn sang trọng, bass mộc dìu dặt',
    bpm: 68,
    icon: Moon,
    color: '#0EA5E9',
  },
